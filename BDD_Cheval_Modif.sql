...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 05 oct. 2020 à 21:27
...
INSERT INTO `cheval` (`id`, `nom`, `sexe`, `prixDepart`, `SIRE`, `img_url`, `id_client`, `id_typeCheval`, `id_mere`, `id_pere`) VALUES
(1, 'Tonnerre', 'M', 100, 'ODL0010', '03.jpg', 23, 2, 5, 5),
(2, 'Fleurette', 'F', 100, 'LOP91093', 'black-head-horse-side-view-with-horsehair.png', 22, 1, 5, 5),
(3, 'Pablo', 'M', 100, 'OLD01LD', '03.jpg', 22, 2, 2, 1),
(4, 'TomChauvin', 'M', 100, 'OLODP9001', 'cheval1.jpg', 22, 2, 2, 1),
(5, 'Parents Inconnus', '/', 0, '/', 'black-head-horse-side-view-with-horsehair.png', 22, 2, NULL, NULL),
(6, 'Hugo', 'F', 100, 'HDF10', 'black-head-horse-side-view-with-horsehair.png', 18, 2, 3, 2);
